...
class MaterialSlider extends MaterialComponent {
  ...
  constructor(optRoot) {
    ...
    this.backgroundLower_ =
        this.root_.querySelector(`.${MaterialSlider.cssClasses_.LOWER}`);
    this.backgroundUpper_ =
        this.root_.querySelector(`.${MaterialSlider.cssClasses_.UPPER}`);
    ...
    this.inputListener_ = this.checkValue_.bind(this);
   ...
   * Set value on slider.
   *
   * @param {number} num The value to set the property to.
   * @export
   */
  set value(num) {
